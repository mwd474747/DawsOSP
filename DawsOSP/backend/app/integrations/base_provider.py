...
class BaseProvider(ABC):
    ...
    def __init__(self, name: str, api_key: str, base_url: str):
        ...
        Args:
            name: Provider identifier (e.g., "fmp", "polygon")
        ...
        self.dlq = DeadLetterQueue(name=f"{name}_dlq", max_retries=3)
        self._cache: Dict[str, ProviderResponse] = {}

        logger.info(f"Initialized provider: {name} (base_url={base_url})")
