"""
DEPRECATED - Legacy Bridge to Archive

This file attempts to import from archived DawsOS v2.0 (archive/legacy_dawsos/).
It is NO LONGER NEEDED as all functionality is now in root directory.

Status: DEPRECATED (October 21, 2025)
Used by: services/prediction_service.py (wrapped in try/except - safe to fail)
Action: Will be removed in future cleanup

Current DawsOS agents are in ./agents/ (not archive/)
"""
