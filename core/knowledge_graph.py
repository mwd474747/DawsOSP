...
class KnowledgeGraph:
    ...
    def get_all_nodes(self, data: bool = True):
        """
        Get all nodes in the graph.

        Args:
            data: If True, return (node_id, node_data) tuples;
                  if False, return node_ids only

        Returns:
            NodeView iterator of nodes

        Note: Added for DawsOS agent compatibility.
        Exposes NetworkX nodes() method.
        """
