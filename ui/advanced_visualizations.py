...
class AdvancedVisualizations:
    ...
    # Professional color scheme using Professional Theme
    COLORS = {
        'background': ProfessionalTheme.COLORS['background'],         # #0A0E27
        'paper': ProfessionalTheme.COLORS['surface'],                 # #0F1629
        'grid': ProfessionalTheme.COLORS['border'],                   # #1E2740
        'text': ProfessionalTheme.COLORS['text_primary'],             # #E8E9F3
        'text_secondary': ProfessionalTheme.COLORS['text_secondary'], # #A0A4B8
        ...
        'purple': ProfessionalTheme.COLORS['accent_purple'],          # #8B5CF6
        'pink': '#EC4899'  # Custom color (not in theme, kept for compatibility)
    }
