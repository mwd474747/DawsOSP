...
class EconomicCalendar:
    ...
    # Event importance colors using Professional Theme
    IMPORTANCE_COLORS = {
        'critical': ProfessionalTheme.COLORS['accent_danger'],    # #EF4444 Red
        'high': ProfessionalTheme.COLORS['accent_warning'],       # #F59E0B Orange
        'medium': ProfessionalTheme.COLORS['accent_success'],     # #10B981 Green
        'low': ProfessionalTheme.COLORS['text_secondary']         # #A0A4B8 Gray
    }
