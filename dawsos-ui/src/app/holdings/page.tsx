...
export default function HoldingsPage() {
  const { data, isLoading, error } = useHoldingsDetail('main-portfolio');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600">Loading holdings data...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="max-w-md">
          ...
          <CardContent>
            <p className="text-slate-600">
              {error.message || 'Failed to load holdings data. Please try again.'}
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time holdings data from backend API
              </CardDescription>
            </CardHeader>
            <CardContent>
