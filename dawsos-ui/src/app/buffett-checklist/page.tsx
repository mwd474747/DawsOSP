    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600">Loading Buffett checklist data...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="max-w-md">
          <CardHeader>
            <CardTitle className="text-red-600">Error Loading Buffett Checklist</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-slate-600">
              {error.message || 'Failed to load Buffett checklist data. Please try again.'}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Warren Buffett investment criteria analysis and quality assessment
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time Buffett checklist data from backend API
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {data?.result ? (
                  ...
                  <p className="text-slate-500">No Buffett checklist data available</p>
                )}
              </div>
            </CardContent>
          </Card>
