...
export default function ReportsPage() {
  const { data, isLoading, error } = useReports('main-portfolio');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600">Loading reports data...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="max-w-md">
          ...
          <CardContent>
            <p className="text-slate-600">
              {error.message || 'Failed to load reports data. Please try again.'}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Comprehensive portfolio reports with PDF generation and export
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time reports data from backend API
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {data?.result ? (
                  ...
                  <p className="text-slate-500">No reports data available</p>
                )}
              </div>
            </CardContent>
          </Card>
